 ...
 * @LastEditTime: 2023-11-06 14:17:19
 */
import Config from '@/config';
import uiclient from '@js-track/platform-api';
import { generateUUID, isFunction } from '@js-track/shared/utils';

class BaseMessage {
	init(): JTBusiness.MonitorParmas {
	 ...
	 * @param {*} systemInfo
	 */
	transformSystemInfo(systemInfo?: AnyObject): JTBusiness.SystemOptions {
		const {
			platform: os_type,
			system: os_version,
			version: wx_version,
